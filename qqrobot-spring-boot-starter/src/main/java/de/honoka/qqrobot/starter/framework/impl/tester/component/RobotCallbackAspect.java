package de.honoka.qqrobot.starter.framework.impl.tester.component;
...
public class RobotCallbackAspect {
    ...
    @Before(
        "execution(* de.honoka.qqrobot.starter.core.DefaultFrameworkCallback.onPrivateMsg" +
    ...
    @Before(
        "execution(* de.honoka.qqrobot.starter.core.DefaultFrameworkCallback.onGroupMsg" +
    ...
    @AfterReturning("execution(* de.honoka.qqrobot.starter.framework.impl.tester.TesterFramework.sendPrivateMsg(..))")
    ...
    @AfterReturning("execution(* de.honoka.qqrobot.starter.framework.impl.tester.TesterFramework.sendGroupMsg(..))")
    ...
    @AfterReturning("execution(* de.honoka.qqrobot.starter.framework.impl.tester.TesterFramework.reply(..))")
