...
class OnebotFramework(
    ...
    inner class WebSocketHandlerImpl : WebSocketHandler {
        ...
        private fun handleMessageEvent(json: JSONObject) {
            ...
            when(json.getStr("message_type")) {
                "private" -> frameworkCallback.onPrivateMsg(group, qq, robotMessage)
    ...
    override fun sendTempPrivateMsg(group: Long, qq: Long, message: RobotMultipartMessage) {
        sendMessage(group, qq, transform(message))
    }
