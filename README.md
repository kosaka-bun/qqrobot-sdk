...
## 快速开始
[qqrobot-demo](https://github.com/honoka-studio/qqrobot-demo)是基于本框架搭建的一个示例程序，其包含了本框架的所有基本用法示例。请先按步骤分别尝试在测试环境与正式环境中尝试运行此Demo应用。

### 测试环境
1. Clone [qqrobot-demo](https://github.com/honoka-studio/qqrobot-demo)仓库。
2. 使用IDE打开qqrobot-demo目录。
...
2. 将[qqrobot-demo/src/main/resources/config/application-prod.yml](https://github.com/honoka-studio/qqrobot-demo/tree/master/src/main/resources/config/application-prod.yml)文件，复制到qqrobot-demo/build/libs目录下。
